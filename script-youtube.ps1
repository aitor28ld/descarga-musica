...
If ($Comprobacion -eq $False) {
    ...
    $url = "https://yt-dl.org/downloads/2017.10.01/youtube-dl.exe"
    ...
    $url1 = "http://ffmpeg.zeranoe.com/builds/win64/static/ffmpeg-20170921-183fd30-win64-static.zip"
    $path1 = "C:\Users\$usuario1\Desktop\Youtube\ffmpeg-20170921-183fd30-win64-static.zip"

    $ffmpeg = New-Object System.Net.WebClient
    $ffmpeg.DownloadFile($url1, $path1)

    # Descomprimos el zip
    Expand-Archive "C:\Users\$usuario1\Desktop\Youtube\ffmpeg-20170921-183fd30-win64-static.zip" -DestinationPath "C:\Users\$usuario1\Desktop\Youtube\"

    # Movemos los ejecutables dentro del directorio Bin al directorio padre Youtube.
    Move-Item "C:\Users\$usuario1\Desktop\Youtube\ffmpeg-20170921-183fd30-win64-static\bin\*" "C:\Users\$usuario1\Desktop\Youtube\"

    #Eliminamos el directorio resultante de la descomprención y el fichero .zip
    cd "C:\Users\$usuario1\Desktop\Youtube"
    rm ffmpeg-20170921-183fd30-win64-stati* -Recurse -Force
